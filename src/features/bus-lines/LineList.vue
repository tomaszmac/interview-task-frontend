<template>
  <section
    class="rounded border border-main-universal-darker-bg bg-app-surface"
    aria-labelledby="line-list-title"
  >
    ...
    >
      <li v-for="line in lines" :key="line">
        <button
          type="button"
          class="focus-ring inline-flex h-8 min-w-[54px] items-center justify-center rounded px-4 py-2 text-xs font-medium leading-4 text-app-surface transition-colors active:bg-brand-active"
